...
public class ElasticSearchService {
    ...
    @Async
    public void reindex() throws IllegalAccessException {
    ...
    @Transactional(readOnly = true)
    @Async
    public void reindexEntity(String entity) throws IllegalAccessException {
    ...
    private void reindex(Reindexer bean) throws IllegalAccessException {
